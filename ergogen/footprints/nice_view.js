module.exports = {
    ...
    body: p => `
        ...
        ${'' /* pin names */}
        (fp_text user MOSI (at 3.5 -5.08 ${p.rot + 180}) (layer F.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15))))
        (fp_text user SCK (at 3.5 -2.54 ${p.rot + 180}) (layer F.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15))))
        ...
        ${'' /* pins */}
        (pad 5 thru_hole oval (at 1.3 -5.08 ${p.rot + 270}) (size 1.7 1.7) (drill 1) (layers *.Cu *.Mask) ${p.MOSI.str})
        (pad 4 thru_hole oval (at 1.3 -2.54 ${p.rot + 270}) (size 1.7 1.7) (drill 1) (layers *.Cu *.Mask) ${p.SCK.str})
...
// (fp_text user MOSI (at 3.5 -5.08 ${p.rot + 180}) (layer B.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15)) (justify mirror)))
// (fp_text user SCK (at 3.5 -2.54 ${p.rot + 180}) (layer B.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15)) (justify mirror)))
